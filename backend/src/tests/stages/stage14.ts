...
`,
    ...
    //         description: "This test aims to ensure proper error handling of the server in case of an invalid HTTP request",
    //         info: "Sends a request to the server with extra spacing between method, path and http version within the request line",
    //         request: `GET  /index.html  HTTP/1.1\r
    // Host: localhost:8001\r
    // \r
    // `,
...
`,
    ...
    //         description: "This test aims to ensure proper error handling of the server in case of an invalid HTTP request",
    //         info: "Sends a request to the server with body but using the GET method",
    //         request: `GET /index.html HTTP/1.1\r
    // Host: localhost:8001\r
    // Content-Length: 10\r
    // \r
